...
export default function App() {
  ...
  if (!activeTeam) {
    return <TeamSelection teams={teams} isAdmin={isAdmin} onSelectTeam={(t) => { setActiveTeam(t); setActiveTab('dashboard'); }} onCreateTeam={(t) => setTeams([...teams, t])} onLogout={handleLogout} />;
  }
  ...
  const currentTrainingPlans = trainingPlans.filter(p => p.teamId === activeTeam.id);
